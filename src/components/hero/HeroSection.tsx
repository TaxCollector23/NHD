    ...
    <section className="relative overflow-hidden border-b border-earth-500/15">
      ...
      <div className="container-museum relative grid lg:grid-cols-[1.12fr_1fr] gap-10 lg:gap-14 items-center py-14 md:py-20">
        <div>
          ...
          >
            From 1802 to 1871, surveyors set out to fix the position of every landmark in India. How do
            you measure ground you cannot walk, and what changes once you can?
          </motion.p>
          ...
          >
            The innovation was not an instrument. The geometry was two centuries old. What was new was the
            framework, and the seventy years of holding it together.
          </motion.p>
          ...
          >
            ...
            <Link to="/tools" className="btn-secondary">Try the tools</Link>
          </motion.div>
          ...
          >
            <span><b className="text-ink-800">1802</b> first baseline measured</span>
            <span><b className="text-ink-800">1818</b> named the Great Trigonometrical Survey</span>
            <span><b className="text-ink-800">Peak XV</b> calculated, not climbed</span>
          </motion.div>
        </div>
        ...
        <div className="relative">
          <div className="relative rounded-lg border border-earth-500/20 bg-parchment-50/40 p-4 shadow-sm">
            ...
            <svg viewBox={INDIA_VIEWBOX} className="w-full h-auto" role="img" aria-label="A network of survey triangles built across a projection of India">
            ...
            <p className="note-text mt-2">
              Station coordinates are real places. The mesh joining them is a teaching schematic, not the
              historical network.
            </p>
          </div>
        </div>
