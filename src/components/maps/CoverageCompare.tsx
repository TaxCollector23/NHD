  ...
  return (
    <figure className="card-parchment p-4 md:p-5">
      ...
      <figcaption className="caption-text mt-4 border-t border-earth-500/20 pt-3">
        A diagram of two ways to organise measurement, not a map of who surveyed what. The dots are real station
        coordinates; the triangle mesh is a teaching schematic rather than the survey's actual network. No historical
        coverage data is shown, because no verified coverage dataset has been assembled for this project.
      </figcaption>
    </figure>
  )
}
