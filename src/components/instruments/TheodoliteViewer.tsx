    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="card-parchment p-4">
        ...
        <p className="text-xs text-ink-800/85 mb-3 leading-snug">
          This is what the surveyor sees. A distant mountain sits in the crosshairs. Drag the fine screw to bring the
          crosshairs onto the peak. An arc-second is 1/3600 of a degree; when this demo's error falls under a minute of
          arc it marks the target as locked. The threshold is the demo's own, not the survey's.
        </p>
        <svg viewBox="0 0 400 300" className="w-full h-auto rounded overflow-hidden">
          ...
          <text x="200" y="290" textAnchor="middle" fontSize="11" fill="#eccb84">
            crosshair at {aim.toFixed(4)}° · target{' '}
      ...
      <div className="card-parchment p-4">
        ...
        <p className="text-xs text-earth-600 mt-2 leading-relaxed">
          Real surveyors read <b>five</b> verniers around the circle and averaged them. That average became the angle
          used in the{' '}
          <Link to="/triangulation" className="underline decoration-dotted">
            Triangulation
          </Link>{' '}
          Law of Sines.
        </p>
