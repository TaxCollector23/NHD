        ...
        >
          ...
          {step >= 3 && (
            <>
              <polygon
                ...
                fill="rgba(75,122,138,0.10)"
                stroke="#3d6b7a"
                strokeWidth="1.6"
                strokeLinejoin="round"
              />
              <circle cx={D.x} cy={D.y} r="5" fill="#3d6b7a" />
              <text x={D.x + 10} y={D.y + 4} fontSize="13" fill="#3d6b7a" fontFamily="Georgia, serif">
                next station
              </text>
            </>
          )}
          ...
          {step >= 2 && (
            <>
              ...
              <text x={150} y={158} fontSize="13" fill="#a8802a" fontFamily="Georgia, serif">
                calculated
              </text>
              <text x={300} y={158} fontSize="13" fill="#a8802a" fontFamily="Georgia, serif">
                calculated
              </text>
            </>
          )}
          ...
          {step === 1 && (
            <>
              ...
              <path
                d={`M ${A.x + 40} ${A.y} A 40 40 0 0 0 ${A.x + 26} ${A.y - 30}`}
                fill="none"
                stroke="#3d6b7a"
                strokeWidth="1.6"
              />
              <path
                d={`M ${B.x - 40} ${B.y} A 40 40 0 0 1 ${B.x - 30} ${B.y - 27}`}
                fill="none"
                stroke="#3d6b7a"
                strokeWidth="1.6"
              />
              <text x={A.x + 44} y={A.y - 22} fontSize="15" fill="#3d6b7a" fontFamily="Georgia, serif">
                angle
              </text>
              <text x={B.x - 88} y={B.y - 22} fontSize="15" fill="#3d6b7a" fontFamily="Georgia, serif">
                angle
              </text>
            </>
          )}
          ...
          <line
            ...
            x2={B.x}
            y2={B.y}
            stroke={step === 0 ? '#0f1a2b' : '#5b3a1e'}
            strokeWidth={step === 0 ? 5 : 3}
            strokeLinecap="round"
          />
          <text
            x={(A.x + B.x) / 2}
