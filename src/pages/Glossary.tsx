  ...
  return (
    <div className="container-museum py-8 md:py-10">
      ...
      <p className="mt-5 max-w-2xl text-lg text-ink-800/85 leading-relaxed">
        Technical terms used in the exhibit. Alphabetical. Also available as
        tooltips on any dotted-underlined term in a chapter.
      </p>
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-x-8">
        {groups.map(([letter, terms]) => (
          <div key={letter} className="mb-6 break-inside-avoid">
            <div className="font-display text-3xl text-brass-600 border-b border-earth-500/20 pb-1 mb-3">
              {letter}
            </div>
        ...
        {!groups.length && (
          <div className="text-earth-600 md:col-span-2">
            No terms match "{q}". Try a shorter query, or clear the search.
          </div>
        )}
      </div>
