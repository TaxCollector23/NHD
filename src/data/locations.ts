...
const RAW: Omit<Station, 'x' | 'y'>[] = [
  ...
  { id: 'madras', name: 'Madras (St. Thomas Mount)', year: 1802, lat: 13.0, lng: 80.2, note: 'First baseline, 1802' },
  ...
  { id: 'sironj', name: 'Sironj', year: 1834, lat: 24.1, lng: 77.7 },
  { id: 'kalianpur', name: 'Kalianpur', year: 1839, lat: 24.13, lng: 77.4, note: 'Origin of Indian geodetic datum' },
  ...
  {
    id: 'peakxv',
    name: 'Peak XV (Everest)',
    year: 1852,
    lat: 27.98,
    lng: 86.92,
    note: 'Identified as highest known by computation; height later published as 29,002 ft',
  },
]
