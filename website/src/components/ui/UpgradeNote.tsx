  ...
  return (
    <div className="mt-4 rounded-md border-l-[3px] border-survey-500 bg-parchment-100/70 p-4">
      <div className="flex items-center gap-2 mb-1.5">
        ...
        <span className="page-eyebrow text-survey-600">What still needs checking</span>
      </div>
      <p className="caption-text">
        {what} The records to check are George Everest's 1847 <i>Account of the Measurement of Two Sections of the
        Meridional Arc of India</i> and Andrew Waugh's 1851 report. Without their tables, this shows the method rather
