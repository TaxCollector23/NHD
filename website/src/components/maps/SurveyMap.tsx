  ...
  return (
    <div className="card-parchment p-5 md:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
        ...
        <EpistemicBadge
          kind="illustrative"
          claim="Selected locations and a simplified triangle mesh showing change over seven decades."
          note="The map uses selected locations from the research record. The triangle mesh is simplified so the growth of the framework can be seen at a glance. It is not the full historical network."
      ...
      <div className="grid lg:grid-cols-[minmax(0,1.55fr)_minmax(0,1fr)] gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2 border-y border-earth-500/20 py-3" aria-live="polite">
            <div>
              <div className="page-eyebrow">Year</div>
              <div className="font-mono text-lg text-ink-900 tabular-nums">{year}</div>
            </div>
            <div>
              <div className="page-eyebrow">Stations shown</div>
              <div className="font-mono text-lg text-ink-900 tabular-nums">{visibleStations.length}</div>
            </div>
            <div>
              <div className="page-eyebrow">Triangle links</div>
              <div className="font-mono text-lg text-ink-900 tabular-nums">{visibleTriangles.length}</div>
            </div>
          </div>
